...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx67e4f3e5e9e0dfdb',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'df7a420f09aba801d845d9ef1ca778f8',
  ...
  USERS: [
    {
      ...
      id: 'oacWs55nKMFgRSNmgPyBxDfTxj8o',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'oSajaqVw7GuEweuNhK-XXc0amXOZX5SAlFY0lgoFyns',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '日照',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '敏敏', year: '2003', date: '03-06',
        },
        
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '敏敏', year: '2003', date: '04-07',
        },
  ...
  CALLBACK_TEMPLATE_ID: 'abaopL_SkjuRiFc06x3Zhs-npJI2TZ8EO4hcT5GAN7k',
